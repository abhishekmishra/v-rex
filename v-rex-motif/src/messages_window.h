...
#ifndef SRC_MESSAGES_WINDOW_H_
#define SRC_MESSAGES_WINDOW_H_
 ...
 * \return error code
 */
vrex_err_t add_messages_entry(vrex_context* vrex, char* msg);

#endif /* SRC_MESSAGES_WINDOW_H_ */

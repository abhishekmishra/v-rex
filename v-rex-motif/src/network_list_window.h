/*
 * v-rex-motif: network_list_window.h
...
#ifndef SRC_NETWORK_LIST_WINDOW_H_
#define SRC_NETWORK_LIST_WINDOW_H_
 ...
 * \return error code.
 */
vrex_err_t make_docker_networks_list_window(vrex_context* vrex,
		Widget parent_w);
...
#endif /* SRC_NETWORK_LIST_WINDOW_H_ */

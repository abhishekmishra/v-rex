...
LIBS=$(CLD_HOME)/obj/docker_*.o $(CLD_HOME)/obj/log.o `pkg-config --libs json-c` `pkg-config --libs libcurl` -L/usr/Motif21/lib -L/usr/X11R6/lib -lXbae -lXm -lXt -lSM -lICE -lX11
